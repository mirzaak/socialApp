<template>
    <main>
        <div v-for="profile in profile" :key="profile">
            <div class="container-lg d-flex bg-white border p-5 align-items-center justify-content-between mt-4" style="height:300px">
        <div class="container-lg d-flex align-items-center">
            ...
            <img class="img border-top border-bottom" :src="profile.image" style="height: 200px">
</div>
    
    <div class="ms-3 d-flex flex-column align-items-center">
        <h1 @click="toProfile(profile.user)" role="button">{{profile.user}}</h1>
